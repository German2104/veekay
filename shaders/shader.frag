...
void main() {
	...
	result += blinnPhong(dir_light_dir, directional_color, directional_intensity, view_dir, normal) * albedo_color;
	...
	for (int i = 0; i < point_lights.length(); ++i) {
		...
		vec3 light_contribution = blinnPhong(light_dir, light.color, light.intensity, view_dir, normal) * albedo_color;
